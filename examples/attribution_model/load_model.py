...
init_mlflow(config_path_or_dict='/srv/dev/mlflow/examples/attribution_model/mlflow-config.yaml')

model_name = 'attribution_model'
stage = 'Staging'
model = mlflow.pyfunc.load_model(model_uri=f'models:/{model_name}/{stage}')

jan_bs_raw = pd.read_feather('/srv/dev/mlflow/examples/attribution_model/data_df.feather')
